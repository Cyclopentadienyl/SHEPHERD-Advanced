...
echo -e ""
echo -e "   2. Quick demo (small built-in graph, ~1 min):"
...
echo -e "      --generate-samples is not optional: without it the workspace has"
echo -e "      no split manifest, and training and serving both refuse it."
echo -e "      ${YELLOW}$PY scripts/build_knowledge_graph.py --workspace data/workspaces/main \\${NC}"
echo -e "      ${YELLOW}    --external-dir data/external --generate-samples \\${NC}"
echo -e "      ${YELLOW}    --num-train 200000 --num-val 40000${NC}"
echo -e "      ${YELLOW}$PY scripts/compute_shortest_paths.py --kg-path data/workspaces/main/kg.json \\${NC}"
echo -e "      ${YELLOW}    --output-dir data/workspaces/main${NC}"
echo -e "      ${YELLOW}$PY scripts/train_model.py --data-dir data/workspaces/main --epochs 50${NC}"
echo -e ""
