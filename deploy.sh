...
echo -e "${YELLOW}      --inexact is required: plain 'uv sync' removes packages that are not in${NC}"
echo -e "${YELLOW}      uv.lock, which includes the PyG native extensions and cuVS installed above.${NC}"
echo -e ""
