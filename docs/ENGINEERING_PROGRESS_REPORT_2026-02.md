...
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   NVIDIA CUDA 13.0 (2025 Q4)                                        │
│        ↓                                                             │
│   PyTorch 2.9.0+cu130 (官方支援版本)                                │
│        ↓                                                             │
│   torch-geometric 2.7.0 (需要 PyTorch 2.9+)                         │
│        ↓                                                             │
│   Python >= 3.12 (PyTorch 2.9 官方支援的最低版本)                   │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```

**PyTorch 官方支援矩陣** (2025-2026)：

| PyTorch 版本 | CUDA 版本 | Python 支援 |
|--------------|-----------|-------------|
| 2.5.x | CUDA 11.8, 12.1 | 3.9 - 3.12 |
| 2.7.x | CUDA 12.4, 12.6 | 3.10 - 3.12 |
| **2.9.x** | **CUDA 13.0** | **3.12 - 3.13** |

> **注意**：PyTorch 2.9.0 已**移除對 Python 3.10/3.11 的支援**，僅支援 3.12+
