...
| [`working/PLAN_SP_ARTIFACT_INTEGRITY.md`](working/PLAN_SP_ARTIFACT_INTEGRITY.md) | The two open shortest-path producer defects — a tensor and a sidecar with nothing binding them, and an artifact that can be written into a workspace it was not computed from. **Draft, not approved** |
